...
#define USE_SEGMENTATION false

extern bool setting_constant_smoothing;
extern bool setting_average_smoothing;
extern bool setting_blob_smoothing;
extern bool setting_segmentation_smoothing;

extern int setting_minSaliencyHistAdd;
extern float setting_minSaliencyMeanWeight;

extern float setting_seg_weights_map[150];


// PixelSelector
extern int setting_patch_size;

extern bool setting_visualize_selection;
